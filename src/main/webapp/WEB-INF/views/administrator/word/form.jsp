...
<acme:form>
    ...
    <acme:form-submit test="${command=='show' || command=='update'}" action="/administrator/word/update" code="administrator.word.form.button.update" />
	<acme:form-submit test="${command=='create'}" action="/administrator/word/create" code="administrator.word.form.button.create" />
	<acme:form-submit test="${command=='show' || command=='update'}" action="/administrator/word/delete" code="administrator.word.form.button.delete" />
